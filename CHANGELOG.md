...
- Find by name uses the original table around gold, before the Platinum and Mercury edits.

## [0.28.24] - 2026-09-17

### Changed

- Mode cards keep the original outline honeycomb and share the same background opacity.

## [0.28.23] - 2026-09-17

### Changed

- All six mode cards use the same honeycomb opacity in the background.

## [0.28.22] - 2026-09-17

### Changed

- Find by name drops the Mercury cell and puts Platinum in the slot left of gold.

## [0.28.21] - 2026-09-17

### Changed

- Atomic number uses the previous neon card again. Find by name keeps gold as the only oversized cell.
...
- Choose-a-mode honeycomb cells are larger, so fewer hexes sit behind the HUD.
...
- Mixed mode card honeycomb is a brighter navy so it matches the other mode icons.

## [0.28.10] - 2026-09-16

### Added

- Choose-a-mode footer has a cyan rule with an atom in the break and Explore · Learn · Discover under it.
...
- Play screens and the periodic table use DM Sans and Fraunces again. Orbitron and Audiowide stay on Choose-a-mode.

## [0.28.5] - 2026-09-16

### Changed

- Honeycomb stays on the edges of Choose-a-mode instead of tiling behind the cards.

## [0.28.4] - 2026-09-16

### Fixed

- Top-bar Elementra wordmark reads as letters instead of a smeared arcade title.
...
- Elementra titles read as letters again instead of a gradient smear.

## [0.28.0] - 2026-09-16

### Added

- How to Play explains modes, scoring, hints, and how a round works.

## [0.27.1] - 2026-09-16

### Fixed

- Periodic table dialog no longer spills into extra sideways and up-down scrolling.
...
- Periodic table button next to Stats opens the complete table.
...
- Mixed icon’s gold Au tile has the same sparkle as the other modes.

## [0.23.21] - 2026-09-16

### Changed

- Mixed icon’s gold Au glow matches the other mode icons.

## [0.23.20] - 2026-09-16

### Changed

- Mixed icon’s gold Au tile is shiny again.

## [0.23.19] - 2026-09-16

### Changed

- Mixed icon’s gold Au tile is even larger.

## [0.23.18] - 2026-09-16

### Changed

- Mixed icon’s gold Au tile is larger than the other element tiles.

## [0.23.17] - 2026-09-16

### Changed

- Atomic number title and Property clues labels are larger and easier to read.

## [0.23.16] - 2026-09-16

### Changed

- Atomic number icon uses a search field and a shuffled tile grid, like gameplay.

## [0.23.15] - 2026-09-16

### Changed

- Atomic number icon shows a shuffled list, so it no longer matches Symbol.

## [0.23.14] - 2026-09-16

### Changed

- Find-by-name icon shows a gold “Find Gold” prompt like gameplay, not a search bar.

## [0.23.13] - 2026-09-16

### Changed

- Properties, Type the name, and Mixed gold Au tiles glow like atomic number.

## [0.23.12] - 2026-09-16

### Changed

- Find-by-name and Find-by-symbol gold tiles glow a little, like atomic number.

## [0.23.11] - 2026-09-16

### Changed

- Mode icons no longer have little element symbols in the background.
...
- Mode-icon hexagon and table backgrounds are barely visible.
...
- Mode icons use richer table, clue, and gold-Au artwork.

## [0.23.6] - 2026-09-16

### Changed

- Mode icons are all the pale ice cyan of the Find-by-name search text.

## [0.23.5] - 2026-09-16

### Changed

- All mode icons use the same light cyan neon.

## [0.23.4] - 2026-09-16

### Changed

- Mode icons have rounded corners.
...
- Mode logos use neon tile icons that match the Find-by-name / Atomic number / Symbol layout.

## [0.23.1] - 2026-09-16

### Fixed

- The element-group menu no longer scrolls left and right.

## [0.23.0] - 2026-09-16

### Added

- Atomic-number (and Mixed number) lists have a search box. Typing a symbol or name brings that element to the top.
...
- Element fact cards on phones stay on screen instead of clipping off the left edge.
...
- Stop building a placeholder Cosmica page in this repo; the live game deploys from `charlietheboss151/cosmica`.
- Elementra deploy now skips `public_html/cosmica/` so it cannot overwrite the Cosmica game.
- Hub Cosmica card says Play now instead of Coming soon.
