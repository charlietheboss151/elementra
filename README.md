...
- **Modes** — tap a mode logo, then pick an element group from the menu. Find by name, symbol, or atomic number; Property Clues; Type the name; or Mixed. The top bar has Home, Settings, Stats, Periodic table, and How to Play.
